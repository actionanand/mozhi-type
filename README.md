...
```bash
git clone https://github.com/actionanand/mozhi-type.git --branch 1-skeleton angular-proj-name
```

```bash
npx degit github:actionanand/mozhi-type#1-skeleton angular-proj-name
```
